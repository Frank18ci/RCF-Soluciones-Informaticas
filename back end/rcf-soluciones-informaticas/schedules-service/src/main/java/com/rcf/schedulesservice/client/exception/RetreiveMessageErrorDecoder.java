package com.rcf.schedulesservice.client.exception;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.rcf.schedulesservice.exception.ErrorResponse;
import com.rcf.schedulesservice.exception.ResourceNotFound;
import com.rcf.schedulesservice.exception.ServiceUnavailableException;
    ...
    public Exception decode(String methodKey, Response response) {
        ...
        if (body != null) {
            try {
                ...
                if (status == 503){
                    return new ServiceUnavailableException("Servicio no disponible");
                }
